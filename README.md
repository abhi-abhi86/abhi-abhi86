...
A Django-based website showcasing my projects, resume, and contact information.

#### **2. Data Analysis & ML Experiments**

A collection of scripts and notebooks focused on data cleaning, model training, and evaluation using Pandas, scikit-learn, and PyTorch.

#### **3. GUI & Tools**

Desktop utilities developed for image processing, report generation, and other productivity-enhancing tasks using PyQt6 and Pillow.
